          ...
          <ul className="flex flex-col font-medium mt-4 rounded-lg bg-orange-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-orange-800 md:dark:bg-transparent dark:border-orange-700">
            <li>
              {idClienteLogado ? (
                ...
                <Link
                  href="/login"
                  className="block py-2 px-3 md:p-0 text-white decoration-orange-400 rounded md:bg-transparent decoration-orange-700 decoration-orange-500 decoration-orange-600 md:dark:bg-transparent"
                  aria-current="page"
                >
